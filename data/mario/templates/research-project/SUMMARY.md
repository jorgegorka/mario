...
Template for `.planning/research/SUMMARY.md` — executive summary of project research with roadmap implications for marketing projects.
...
**Domain:** [inferred domain type] — marketing content project
**Researched:** [date]
...
- What type of marketing project this is and how experienced marketing teams approach it
- The recommended approach based on research (channels, messaging strategy, content mix)
- Key risks specific to this kind of marketing project and how to mitigate them
...
**Email marketing:**
- [ESP]: [purpose] — [why recommended — e.g., ConvertKit for creator simplicity, ActiveCampaign for automation complexity, Mailchimp for all-in-one basics]

**Analytics & measurement:**
- [Tool]: [purpose] — [why recommended — e.g., Google Analytics for comprehensive data, Plausible for privacy-first simplicity]

**Social media:**
- [Approach]: [purpose] — [why recommended — e.g., LinkedIn for B2B reach, Twitter for developer audience, Instagram for visual brands]

**Advertising:**
- [Platform]: [purpose] — [why recommended — e.g., Google Ads for search intent, Meta Ads for audience targeting, LinkedIn Ads for B2B]

**CRM & sales:**
- [Tool]: [purpose] — [why recommended — e.g., HubSpot for all-in-one, Pipedrive for simplicity, Salesforce for enterprise scale]

**Design & creative:**
- [Tool]: [purpose] — [why recommended — e.g., Canva for quick social graphics, Figma for brand system management]
...
2. [Web content] — [approach — e.g., homepage, landing pages, feature pages, comparison pages]
3. [Email content] — [approach — e.g., welcome sequence, nurture flows, campaigns]
4. [Social content] — [approach — e.g., platform-specific content, posting cadence, community engagement]
5. [Blog/SEO content] — [approach — e.g., pillar pages, topic clusters, keyword targeting]
6. [Paid content] — [approach — e.g., ad copy, creative assets, landing page optimization]

**Growth model (if applicable):**
- [Strategy] — [e.g., content-led growth with SEO, product-led with onboarding optimization, sales-led with ABM]

**Content repurposing (if applicable):**
- [Approach] — [e.g., pillar-to-social workflow, blog-to-email repurposing, webinar-to-content atomization]

### Critical Pitfalls

[Top 5-7 from PITFALLS.md — marketing-specific risks identified through research]

1. **[Inconsistent brand voice]** — [where it applies and how to avoid — e.g., create voice guide before any content, review all content against voice matrix]
2. **[Feature-focused copy]** — [how to avoid — e.g., customer research first, benefit-driven copy review checklist]
3. **[Missing buyer journey content]** — [how to avoid — e.g., map content to funnel stages, audit gaps before creating new content]
4. **[No measurement framework]** — [how to avoid — e.g., define KPIs before launch, install tracking on day one]
5. **[Content without distribution]** — [how to avoid — e.g., distribution plan per content piece, promotion budget allocation]
...
- [Gap]: [how to handle during planning/execution — e.g., "audience size and behavior unknown, affects channel selection and budget allocation"]
- [Gap]: [how to handle during planning/execution — e.g., "competitor ad spend data unavailable, affects paid strategy"]
- [Gap]: [how to handle during planning/execution — e.g., "content production capacity unclear, affects publishing cadence commitments"]

## Sources

### Primary (HIGH confidence)
- [Industry benchmarks and reports] — [topics covered]
- [Platform documentation and best practices] — [topics]
- [Customer interview data or surveys] — [what was checked]

### Secondary (MEDIUM confidence)
- [Marketing community discussions / expert blogs] — [finding]
- [Source] — [finding]
...
- Include the key marketing strategy recommendation and main risk
- Reference the marketing patterns that apply and where the project diverges from standard approaches
...
- Start from standard marketing content organization and note deviations
- Be explicit about channel priorities and content production workflow
- Address content repurposing and distribution patterns
- Note growth model and content scaling approach if applicable

**Critical Pitfalls:**
- Prioritize marketing-specific pitfalls: brand inconsistency, feature-focused copy, missing measurement, deliverability issues
- Include compliance and legal risks relevant to the marketing channels
...
- HIGH = verified with industry benchmarks, platform documentation, or customer data
