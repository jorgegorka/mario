# Marketing Channels Research Template

Template for `.planning/research/CHANNELS.md` — discovered marketing tools, channels, and platform landscape for the project.
...
---
*Marketing channels research for: [project name]*
*Researched: [date]*
```
