...
Template for `.mario_planning/plans/XX-name/{plan}-USER-SETUP.md` - human-required configuration that Claude cannot automate.
...
**Searchability:** `grep -r "USER-SETUP" .mario_planning/` finds all plans with user requirements.
