...
Template for `.mario_planning/debug/[slug].md` — active debug session tracking.
...
**Creation:** Immediately when /mario:debug is called
...
**On resolution:**
- status → "resolved"
- Move file to .mario_planning/debug/resolved/
