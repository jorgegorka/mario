...
Template for spawning mario-debugger agent. The agent contains all debugging expertise - this template provides problem context only.
...
```python
Task(prompt=template, subagent_type="mario-debugger", description="Debug UAT-001")
```
