...
Todos are captured during work sessions with /mario:add-todo.
...
- `/mario:check-todos` → show all
- `/mario:check-todos api` → filter to area:api only
</step>
...
- `/mario:check-todos [area]` to filter by area
- `q` to exit
```
