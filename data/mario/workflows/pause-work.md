...
```bash
timestamp=$(mario-tools current-timestamp full --raw)
```
</step>

<step name="commit">
```bash
mario-tools commit "wip: [phase-name] paused at task [X]/[Y]" --files .planning/phases/*/.continue-here.md
```
</step>
