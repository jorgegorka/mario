...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /mario:research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ~/.claude/mario/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/mario/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/mario/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/mario/templates/discovery.md
...
Use ~/.claude/mario/templates/discovery.md.
...
1. Discuss phase context (/mario:discuss-phase [current-phase])
2. Create phase plan (/mario:plan-phase [current-phase])
