<purpose>
Create executable phase prompts (PLAN.md files) for a roadmap phase with integrated research and verification. Default flow: Research (if needed) -> Plan -> Verify -> Done. Orchestrates mario-phase-researcher, mario-planner, and mario-plan-checker agents with a revision loop (max 3 iterations).
</purpose>
...
```bash
INIT=$(mario-tools init plan-phase "$PHASE" --include state,roadmap,requirements,context,research,verification,uat)
```
...
```bash
PHASE_INFO=$(mario-tools roadmap get-phase "${PHASE}")
```
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Mario ► RESEARCHING PHASE {X}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

◆ Spawning researcher...
```

### Spawn mario-phase-researcher

```bash
PHASE_DESC=$(mario-tools roadmap get-phase "${PHASE}" | jq -r '.section')
...
STATE_SNAP=$(mario-tools state-snapshot)
...
<phase_context>
IMPORTANT: If CONTEXT.md exists below, it contains user decisions from /mario:discuss-phase.
...
```
Task(
  prompt="First, read ~/.claude/agents/mario-phase-researcher.md for your role and instructions.\n\n" + research_prompt,
...
## 8. Spawn mario-planner Agent

Display banner:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Mario ► PLANNING PHASE {X}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
**Phase Context:**
IMPORTANT: If context exists below, it contains USER DECISIONS from /mario:discuss-phase.
...
<downstream_consumer>
Output consumed by /mario:execute-phase. Plans need:
...
## 10. Spawn mario-plan-checker Agent

Display banner:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Mario ► VERIFYING PLANS
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
Task(
  ...
  subagent_type="mario-plan-checker",
  model="{checker_model}",
...
- /mario:plan-phase {X} --research — re-research first
...
- [ ] mario-phase-researcher spawned with CONTEXT.md
- [ ] Existing plans checked
- [ ] mario-planner spawned with CONTEXT.md + RESEARCH.md
- [ ] Plans created (PLANNING COMPLETE or CHECKPOINT handled)
- [ ] mario-plan-checker spawned with CONTEXT.md
