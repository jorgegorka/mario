require "test_helper"
require "mario/tools/frontmatter"

class FrontmatterTest < Minitest::Test
  def test_extract_simple
    content = "---\nphase: 1\nplan: 2\ntype: execute\n---\n\n# Body"
    fm = Mario::Tools::Frontmatter.extract(content)
  ...
  def test_reconstruct_simple
    obj = { "phase" => "1", "plan" => "2" }
    result = Mario::Tools::Frontmatter.reconstruct(obj)
  ...
  def test_splice_replaces_frontmatter
    ...
    result = Mario::Tools::Frontmatter.splice(content, new_obj)
  ...
  def test_body_extraction
    content = "---\nphase: 1\n---\n\n# My Body"
    body = Mario::Tools::Frontmatter.body(content)
  ...
  def test_plan_validates_with_domain_field
    ...
    fm = Mario::Tools::Frontmatter.extract(plan_content)
    required = Mario::Tools::Frontmatter::SCHEMAS["plan"]
